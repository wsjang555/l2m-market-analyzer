...
ALL_ARMOR_NAMES = [
    ...
    "집중의 셔츠", "자경대원 셔츠", "면 셔츠", "무명 셔츠", "완력의 미스릴 셔츠", "완력의 무명 셔츠",
    # 망토
    "샐러맨더 망토", "샐러맨더의 망토", "운디네 망토", "운디네의 망토", "실리드 망토", "노움 망토", "낡은 천 망토",
    # 시길
    "티어 오브 다크니스", "자이브의 시길", "스피릿 시길", "불사조의 명예",
    "기사단의 명예", "수장 가문 시길", "오키쉬 시길", "청동 시길", "철 시길", "나무 시길",
    "페어리 시길", "님프 시길", "스켈레톤 시길",
    "기사단의 유물", "현자의 유물",
    # 견갑
    "에파울렛 오브 피닉스", "에파울렛 오브 더 블러드", "현자의 견갑",
# 자동 추가
...
async def run_fast_armor_scanner(target_grade, p0_target_price, pX_level, server_id=1211):
    ...
    print(f"\n[Top3] 방어구 (0강<={p0_target_price}, +{pX_level}강 차이순):")
